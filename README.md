...
* moderator:manage:unban_requests - unban requests
* moderator:manage:warnings - can provide warnings to users

All possible scopes can be found at: [https://dev.twitch.tv/docs/authentication/scopes/](https://dev.twitch.tv/docs/authentication/scopes/)
